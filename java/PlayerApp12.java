/*WAP to create class name as Player with field id,name,age,run and sort player by run in descending order as well as show the player list whose run is more than 1000 and age less than equal 25*/
